...
TTargetingArea.actions.add('START', (inst, event, pl, abil) => {enableDrawing(true, pl, abil)})
TTargetingArea.actions.add('END', (inst, event, pl, abil) => {enableDrawing(false, pl, abil)})
